...
utf8chr(const utf8_int8_t *src, rune chr);
...
utf8_nonnull utf8_weak int utf8makevalid(utf8_int8_t *str,
                                         const rune replacement);

utf8_constexpr14 utf8_nonnull rune
utf8decode(const utf8_int8_t *utf8_restrict str);
...
utf8codepoint(const utf8_int8_t *utf8_restrict str,
              rune *utf8_restrict out_codepoint);
...
utf8_constexpr14 size_t utf8codepointsize(rune chr);
 ...
 * null. */
utf8_nonnull utf8_weak utf8_int8_t *
utf8catcodepoint(utf8_int8_t *str, rune chr, size_t n);

/* Returns 1 if the given character is lowercase, or 0 if it is not. */
utf8_constexpr14 int utf8islower(rune chr);

/* Returns 1 if the given character is uppercase, or 0 if it is not. */
utf8_constexpr14 int utf8isupper(rune chr);
...
utf8_constexpr14 rune utf8lwrcodepoint(rune cp);

/* Make a codepoint upper case if possible. */
utf8_constexpr14 rune utf8uprcodepoint(rune cp);
...
utf8_constexpr14_impl int utf8casecmp(const utf8_int8_t *src1,
                                      const utf8_int8_t *src2) {
  rune src1_lwr_cp = 0, src2_lwr_cp = 0, src1_upr_cp = 0,
...
int utf8makevalid(utf8_int8_t *str, const rune replacement) {
...
utf8_constexpr14_impl rune utf8decode(const utf8_int8_t *utf8_restrict str) {
    rune result;
    utf8codepoint(str, &result);
    return result;
}
...
utf8_constexpr14_impl size_t utf8codepointsize(rune chr) {
...
utf8_int8_t *utf8catcodepoint(utf8_int8_t *str, rune chr, size_t n) {
  if (0 == ((rune)0xffffff80 & chr)) {
    /* 1-byte/7-bit ascii
     * (0b0xxxxxxx) */
    if (n < 1) {
...
utf8_constexpr14_impl int utf8islower(rune chr) {
  return chr != utf8uprcodepoint(chr);
}

utf8_constexpr14_impl int utf8isupper(rune chr) {
...
utf8_constexpr14_impl rune utf8lwrcodepoint(rune cp) {
...
utf8_constexpr14_impl rune utf8uprcodepoint(rune cp) {
